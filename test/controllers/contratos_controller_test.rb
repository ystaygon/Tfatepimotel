...
class ContratosControllerTest < ActionController::TestCase
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post :create, contrato: { Con_Desconto: @contrato.Con_Desconto, Con_Dtvenda: @contrato.Con_Dtvenda, Con_Id: @contrato.Con_Id, Con_Vendatotal: @contrato.Con_Vendatotal }
    end
  ...
  test "should update contrato" do
    patch :update, id: @contrato, contrato: { Con_Desconto: @contrato.Con_Desconto, Con_Dtvenda: @contrato.Con_Dtvenda, Con_Id: @contrato.Con_Id, Con_Vendatotal: @contrato.Con_Vendatotal }
    assert_redirected_to contrato_path(assigns(:contrato))
  end
